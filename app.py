...
def upload():
    ...
    #Style Tags, Header, Table Initialization
    html_list =  '<style>\n    p { text-align:left;  }\n    a { color: inherit; text-decoration: none; }\n    .modal-window { position: fixed; background-color: rgba(255, 255, 255, 0.25); top: 0; right: 0; bottom: 0; left: 0; z-index: 999; visibility: hidden; opacity: 0; pointer-events: none; transition: all 0.3s; }\n    .modal-window:target { visibility: visible; opacity: 1; pointer-events: auto; }\n    .modal-window > div { border: 1px solid black; width: 475px; height: auto; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); padding: 2em; background: white; }\n    .modal-close { color: #aaa; line-height: 50px; font-size: 80%; position: absolute; right: 0; text-align: center; top: 0; width: 70px; text-decoration: none; }\n    .modal-close hover { color: black; }\n</style>\n\n'
    html_list += '<h1 style="text-align:center;">Exif Report</h1>\n'
    html_list += '<a href="/"><input class="btn btn-secondary" type="submit" value="Back to Home" style="position:absolute; top:15; left:15;"></a>'
    html_list += '<table class="table" style="margin-bottom:auto;padding: 10px;width: 40%;margin-left: auto;margin-right: auto;">\n'
    
    #image contains basic file ingormation
    html_list += '<tr>\n'
    html_list += '<th colspan="2" style="text-align: center"><b>File Information<b></th>'
    html_list += '</tr>\n'
    html_list += '<tr>\n    <th>Name</th>\n    <th>Value</th>\n</tr>\n\n'

    #Pillow Version
    html_list += '<tr>\n'
    html_list += '    <div class="interior">\n        <td data-th="Name">\n            <a href="#PillowVersionInfo">Pillow Version</a>\n        </td>\n    </div>\n'
    html_list += '<div id="PillowVersionInfo" class="modal-window">\n  <div>\n<a href="#report" title="Close" class="modal-close">Close</a>\n'
    html_list += '<p>'+'<b>Tag Name:</b>Pillow Version<br>\n'
    html_list += '<p>'+'<b>Value:</b> '+ str(Image.__version__) +'<br>\n'
    html_list += '<br>\n'
    html_list += '<p>'+'<b>Description:</b><br>\n'
    html_list += '<p> The current version of the Pillow module used to gather certain image information.</p>\n'
    html_list += '<td data-th="Value">'+ str(Image.__version__) + '</td>\n'
    html_list += '</tr>\n'

    #Filename
    html_list += '<tr>\n'
    html_list += '    <div class="interior">\n        <td data-th="Name">\n            <a href="#FilenameInfo">Filename</a>\n        </td>\n    </div>\n'
    html_list += '<div id="FilenameInfo" class="modal-window">\n  <div>\n<a href="#report" title="Close" class="modal-close">Close</a>\n'
    html_list += '<p>'+'<b>Tag Name:</b>Filename<br>\n'
    html_list += '<p>'+'<b>Value:</b> '+ str(uploaded_file.filename) +'<br>\n'
    html_list += '<br>\n'
    html_list += '<p>'+'<b>Description:</b><br>\n'
    html_list += '<p> The current name of the uploaded image file.</p>\n'
    html_list += '<td data-th="Value">'+ str(uploaded_file.filename) + '</td>\n'
    html_list += '</tr>\n'

    #File Format
    html_list += '<tr>\n'
    html_list += '    <div class="interior">\n        <td data-th="Name">\n            <a href="#FormatInfo">File Format</a>\n        </td>\n    </div>\n'
    html_list += '<div id="FormatInfo" class="modal-window">\n  <div>\n<a href="#report" title="Close" class="modal-close">Close</a>\n'
    html_list += '<p>'+'<b>Tag Name:</b>File Format<br>\n'
    html_list += '<p>'+'<b>Value:</b> '+ str(image.format) +'<br>\n'
    html_list += '<br>\n'
    html_list += '<p>'+'<b>Description:</b><br>\n'
    html_list += '<p> The current file extension of the uploaded image.</p>\n'
    html_list += '<td data-th="Value">'+ str(image.format) + '</td>\n'
    html_list += '</tr>\n'
    ...
    html_list += '<tr>\n'
    html_list += '    <div class="interior">\n        <td data-th="Name">\n            <a href="#FileSizeBytesInfo">File Size (Bytes)</a>\n        </td>\n    </div>\n'
    html_list += '<div id="FileSizeBytesInfo" class="modal-window">\n  <div>\n<a href="#report" title="Close" class="modal-close">Close</a>\n'
    html_list += '<p>'+'<b>Tag Name:</b>File Size (Bytes)<br>\n'
    html_list += '<p>'+'<b>Value:</b> '+ str(b) +'<br>\n'
    html_list += '<br>\n'
    html_list += '<p>'+'<b>Description:</b><br>\n'
    html_list += '<p> The current size of the uploaded image file in bytes.</p>\n'
    html_list += '<td data-th="Value">'+ str(b) + '</td>\n'
    html_list += '</tr>\n'

    #File Size (Mebibytes)
    mib = uploaded_file.tell()/1024/1024
    html_list += '<tr>\n'
    html_list += '    <div class="interior">\n        <td data-th="Name">\n            <a href="#FileSizeMebibytesInfo">File Size (Mebibytes)</a>\n        </td>\n    </div>\n'
    html_list += '<div id="FileSizeMebibytesInfo" class="modal-window">\n  <div>\n<a href="#report" title="Close" class="modal-close">Close</a>\n'
    html_list += '<p>'+'<b>Tag Name:</b>File Size (Mebibytes)<br>\n'
    html_list += '<p>'+'<b>Value:</b> '+ str(mib) +'<br>\n'
    html_list += '<br>\n'
    html_list += '<p>'+'<b>Description:</b><br>\n'
    html_list += '<p> The current size of the uploaded image file in mebibytes.</p>\n'
    html_list += '<td data-th="Value">'+ str(mib) + '</td>\n'
    html_list += '</tr>\n'

    #Width
    html_list += '<tr>\n'
    html_list += '    <div class="interior">\n        <td data-th="Name">\n            <a href="#WidthInfo">Width</a>\n        </td>\n    </div>\n'
    html_list += '<div id="WidthInfo" class="modal-window">\n  <div>\n<a href="#report" title="Close" class="modal-close">Close</a>\n'
    html_list += '<p>'+'<b>Tag Name:</b>Width<br>\n'
    html_list += '<p>'+'<b>Value:</b> '+ str(image.width) +'<br>\n'
    html_list += '<br>\n'
    html_list += '<p>'+'<b>Description:</b><br>\n'
    html_list += '<p> The width of the uploaded image file, in pixels.</p>\n'
    html_list += '<td data-th="Value">'+ str(image.width) + '</td>\n'
    html_list += '</tr>\n'

    #Height
    html_list += '<tr>\n'
    html_list += '    <div class="interior">\n        <td data-th="Name">\n            <a href="#HeightInfo">Height</a>\n        </td>\n    </div>\n'
    html_list += '<div id="HeightInfo" class="modal-window">\n  <div>\n<a href="#report" title="Close" class="modal-close">Close</a>\n'
    html_list += '<p>'+'<b>Tag Name:</b>Height<br>\n'
    html_list += '<p>'+'<b>Value:</b> '+ str(image.height) +'<br>\n'
    html_list += '<br>\n'
    html_list += '<p>'+'<b>Description:</b><br>\n'
    html_list += '<p> The height of the uploaded image file, in pixels.</p>\n'
    html_list += '<td data-th="Value">'+ str(image.height) + '</td>\n'
    html_list += '</tr>\n'

    #Megapixels
    mp = (image.width * image.height) / 1000000
    html_list += '<tr>\n'
    html_list += '    <div class="interior">\n        <td data-th="Name">\n            <a href="#MegapixelsInfo">Megapixels</a>\n        </td>\n    </div>\n'
    html_list += '<div id="MegapixelsInfo" class="modal-window">\n  <div>\n<a href="#report" title="Close" class="modal-close">Close</a>\n'
    html_list += '<p>'+'<b>Tag Name:</b>Megapixels<br>\n'
    html_list += '<p>'+'<b>Value:</b> '+ str(mp) +'<br>\n'
    html_list += '<br>\n'
    html_list += '<p>'+'<b>Description:</b><br>\n'
    html_list += '<p> Identifies how big the image is in megapixels, which is equal to one million pixels.</p>\n'
    html_list += '<td data-th="Value">'+ str(mp) + '</td>\n'
    html_list += '</tr>\n'

    #IsAnimated
    #html_list += '<tr>\n'
    #html_list += '    <div class="interior">\n        <td data-th="Name">\n            <a href="#IsAnimatedInfo">Is Animated</a>\n        </td>\n    </div>\n'
    #html_list += '<div id="IsAnimatedInfo" class="modal-window">\n  <div>\n<a href="#report" title="Close" class="modal-close">Close</a>\n'
    #html_list += '<p>'+'<b>Tag Name:</b>IsAnimated<br>\n'
    #if str(image.is_animated) is None:
    #  html_list += '<p>'+'<b>Value:</b>None<br>\n'
    #else:
    #  html_list += '<p>'+'<b>Value:</b>'+ str(image.is_animated) +'<br>\n'
    #html_list += '<br>\n'
    #html_list += '<p>'+'<b>Description:</b><br>\n'
    #html_list += '<p> Identifies if an uploaded image is animated or not.</p>\n'
    #html_list += '<td data-th="Value">'+ str(image.is_animated) + '</td>\n'
    #html_list += '</tr>\n'

    #Number of Frames
    #html_list += '<tr>\n'
    #html_list += '    <div class="interior">\n        <td data-th="Name">\n            <a href="#nFramesInfo">Number of Frames</a>\n        </td>\n    </div>\n'
    #html_list += '<div id="nFramesInfo" class="modal-window">\n  <div>\n<a href="#report" title="Close" class="modal-close">Close</a>\n'
    #html_list += '<p>'+'<b>Tag Name:</b>c<br>\n'
    #html_list += '<p>'+'<b>Value:</b> '+ str(image.n_frames) +'<br>\n'
    #html_list += '<br>\n'
    #html_list += '<p>'+'<b>Description:</b><br>\n'
    #html_list += '<p> Refers to the number of available frames within an image. </p>\n'
    #html_list += '<td data-th="Value">'+ str(image.n_frames) + '</td>\n'
    #html_list += '</tr>\n'

    #Mode
    html_list += '<tr>\n'
    html_list += '    <div class="interior">\n        <td data-th="Name">\n            <a href="#ModeInfo">Mode</a>\n        </td>\n    </div>\n'
    html_list += '<div id="ModeInfo" class="modal-window">\n  <div>\n<a href="#report" title="Close" class="modal-close">Close</a>\n'
    html_list += '<p>'+'<b>Tag Name:</b>Mode<br>\n'
    html_list += '<p>'+'<b>Value:</b> '+ str(image.mode) +'<br>\n'
    html_list += '<br>\n'
    html_list += '<p>'+'<b>Description:</b><br>\n'
    html_list += '<p> Image mode. This is a string specifying the pixel format used by the image. </p>\n'
    html_list += '<td data-th="Value">'+ str(image.mode) + '</td>\n'
    html_list += '</tr>\n'
    ...
    for x in image.info:
      if x == 'exif' or x == 'mp' or x == 'icc_profile':
        continue
      print(x)#Name
      print(image.info[x])#Value
      html_list += '<tr>\n'
      html_list += '    <div class="interior">\n        <td data-th="Name">\n            <a href="#'+x+'Info">'+ x + '</a>\n        </td>\n    </div>\n'
      html_list += '<div id="'+x+'Info" class="modal-window">\n  <div>\n<a href="#report" title="Close" class="modal-close">Close</a>\n'
      html_list += '<p>'+'<b>Tag Name:</b> '+x+'<br>\n'
      html_list += '<p>'+'<b>Value:</b> '+ str(image.info[x]) +'<br>\n'
      html_list += '<td data-th="Value">'+ str(image.info[x]) + '</td>\n'
      html_list += '</tr>\n'
    ...
    if len(tags) == 0:
      ...
      if str(image.format) != 'TIFF':
        for k, v in image._getexif().items():
            ...
            if tag == 'GPSInfo':
                ...
                html_list += '<tr>\n'
                html_list += '<th colspan="2" style="text-align: center"><b>Location Information<b></th>'
                html_list += '</tr>\n'
                html_list += '<tr>\n    <th>Name</th>\n    <th>Value</th>\n</tr>\n\n'

                html_list += '<tr>'
                html_list += '<td data-th="Name">'+ 'Latitude' + '</td>\n'
                html_list += '<td data-th="Value">'+ '{0:.10f}'.format(lat) + '</td>\n'
                html_list += '</tr>'

                html_list += '<tr>'
                html_list += '<td data-th="Name">'+ 'Longitude' + '</td>\n'
                html_list += '<td data-th="Value">'+ '{0:.10f}'.format(long) + '</td>\n'
                html_list += '</tr>'
      ...
      html_list += '<tr>\n'
      html_list += '    <th colspan="2" style="text-align: center"><b>Exif Data<b></th>'
      html_list += '</tr>\n'
      html_list += '<tr>\n    <th>Name</th>\n    <th>Value</th>\n</tr>\n\n'
      ...
      for tag in tags.keys():
        ...
        html_list += '<br>\n'
        html_list += '<p>'+'<b>Description:</b><br>\n'
        html_list += str(ExifDict[res][1]) +'</p>\n'
